...
[Home](../README.md) · [120 prompt recipes](../prompts/README.md) · [bestimage.ai workflow](bestimage-ai-api-guide.md) · [15-language directory](../prompts/i18n/README.md)
...
On bestimage.ai, reference-to-video requires at least one reference video in addition to any optional images/audio. Image-to-video instead takes a first frame and optional end frame; do not treat the multi-image example below as its request schema. Match creative labels to the actual uploaded media and consult the [mode guide](bestimage-ai-api-guide.md).
